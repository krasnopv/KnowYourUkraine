      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-slate-800 mb-4">
            Про <span className="text-blue-600">нас</span>
          </h1>
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-slate-800 mb-6 flex items-center gap-3">
            <span className="text-blue-600">🎯</span> Наша місія
          </h2>
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-slate-800 mb-6 flex items-center gap-3">
            <span className="text-blue-600">💡</span> Наші цінності
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={value.title} className="p-6 bg-white rounded-2xl border border-slate-200 shadow-sm">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-800 mb-6 flex items-center gap-3">
            <span className="text-blue-600">👥</span> Наша команда
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={member.name} className="text-center p-6 bg-white rounded-2xl border border-slate-200 shadow-sm">
